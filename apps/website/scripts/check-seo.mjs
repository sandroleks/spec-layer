...
if (!(site.indexable && site.cloudflareManagedRobots)) assert.match(robots, /User-agent: \*\nContent-Signal: search=yes,ai-train=no,use=reference\nAllow: \//);
if (!(site.indexable && site.cloudflareManagedRobots)) assert.match(robots, /User-agent: GPTBot\nDisallow: \//);
